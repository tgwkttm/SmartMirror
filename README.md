...
**Repository Address:**  
[https://github.com/tgwkttm/SmartMirror](https://github.com/tgwkttm/SmartMirror)
...
1. Download the `firebase_config.json` file from Firebase Console.
2. Place the file in the main project directory.
...
Ensure the camera drivers are installed:
```sh
